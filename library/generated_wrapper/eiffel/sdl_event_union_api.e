...
feature {ANY} -- Member Access
	...
	set_display (a_value: POINTER )
		...
		do
			...
			display_set: display = a_value 		end
	...
	set_jbutton (a_value: POINTER )
		...
		do
			...
			jbutton_set: jbutton = a_value 		end
	...
	set_jdevice (a_value: POINTER )
		...
		do
			...
			jdevice_set: jdevice = a_value 		end
	...
	set_cbutton (a_value: POINTER )
		...
		do
			...
			cbutton_set: cbutton = a_value 		end
	...
	set_cdevice (a_value: POINTER )
		...
		do
			...
			cdevice_set: cdevice = a_value 		end
	...
	set_adevice (a_value: POINTER )
		...
		do
			...
			adevice_set: adevice = a_value 		end
	...
	set_tfinger (a_value: POINTER )
		...
		do
			...
			tfinger_set: tfinger = a_value 		end
	...
	set_mgesture (a_value: POINTER )
		...
		do
			...
			mgesture_set: mgesture = a_value 		end
	...
	set_dgesture (a_value: POINTER )
		...
		do
			...
			dgesture_set: dgesture = a_value 		end
	...
	padding: POINTER 
		...
		do
			...
			result_correct: Result = c_padding (item)		end
