...
class SDL_JOY_DEVICE_EVENT_STRUCT_API
...
feature {NONE} -- Implementation wrapper for struct struct SDL_JoyDeviceEvent
	...
	c_type (an_item: POINTER): NATURAL
		...
		alias
			"[
				((struct SDL_JoyDeviceEvent*)$an_item)->type
			]"
		end
	...
	set_c_type (an_item: POINTER; a_value: NATURAL) 
		...
		alias
			"[
				((struct SDL_JoyDeviceEvent*)$an_item)->type =  (Uint32)$a_value
			]"
		ensure
	...
	c_timestamp (an_item: POINTER): NATURAL
		...
		alias
			"[
				((struct SDL_JoyDeviceEvent*)$an_item)->timestamp
			]"
		end
	...
	set_c_timestamp (an_item: POINTER; a_value: NATURAL) 
		...
		alias
			"[
				((struct SDL_JoyDeviceEvent*)$an_item)->timestamp =  (Uint32)$a_value
			]"
		ensure
	...
	c_which (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct SDL_JoyDeviceEvent*)$an_item)->which
			]"
		end
	...
	set_c_which (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct SDL_JoyDeviceEvent*)$an_item)->which =  (Sint32)$a_value
			]"
		ensure
