...
-- functions wrapper
class SDL_HINTS_FUNCTIONS_API


feature -- Access

	sdl_set_hint_with_priority (name: STRING_8; value: STRING_8; priority: INTEGER): INTEGER 
		local
	...
	sdl_set_hint (name: POINTER; value: POINTER): INTEGER
		external
			"C inline use <SDL.h>"
		alias
			"[
...
feature -- Externals
	...
	c_sdl_set_hint_with_priority (name: POINTER; value: POINTER; priority: INTEGER): INTEGER
		external
			"C inline use <SDL.h>"
		alias
			"[
