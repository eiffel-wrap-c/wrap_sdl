...
class SDL_CONTROLLER_AXIS_EVENT_STRUCT_API
...
feature {NONE} -- Implementation wrapper for struct struct SDL_ControllerAxisEvent
	...
	c_type (an_item: POINTER): NATURAL
		...
		alias
			"[
				((struct SDL_ControllerAxisEvent*)$an_item)->type
			]"
		end
	...
	set_c_type (an_item: POINTER; a_value: NATURAL) 
		...
		alias
			"[
				((struct SDL_ControllerAxisEvent*)$an_item)->type =  (Uint32)$a_value
			]"
		ensure
	...
	c_timestamp (an_item: POINTER): NATURAL
		...
		alias
			"[
				((struct SDL_ControllerAxisEvent*)$an_item)->timestamp
			]"
		end
	...
	set_c_timestamp (an_item: POINTER; a_value: NATURAL) 
		...
		alias
			"[
				((struct SDL_ControllerAxisEvent*)$an_item)->timestamp =  (Uint32)$a_value
			]"
		ensure
	...
	c_which (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct SDL_ControllerAxisEvent*)$an_item)->which
			]"
		end
	...
	set_c_which (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct SDL_ControllerAxisEvent*)$an_item)->which =  (SDL_JoystickID)$a_value
			]"
		ensure
			which_set: a_value = c_which (an_item)
		end

	c_axis (an_item: POINTER): CHARACTER
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
		alias
			"[
				((struct SDL_ControllerAxisEvent*)$an_item)->axis
			]"
		end

	set_c_axis (an_item: POINTER; a_value: CHARACTER) 
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
		alias
			"[
				((struct SDL_ControllerAxisEvent*)$an_item)->axis =  (Uint8)$a_value
			]"
		ensure
	...
	c_padding1 (an_item: POINTER): CHARACTER
		...
		alias
			"[
				((struct SDL_ControllerAxisEvent*)$an_item)->padding1
			]"
		end
	...
	set_c_padding1 (an_item: POINTER; a_value: CHARACTER) 
		...
		alias
			"[
				((struct SDL_ControllerAxisEvent*)$an_item)->padding1 =  (Uint8)$a_value
			]"
		ensure
	...
	c_padding2 (an_item: POINTER): CHARACTER
		...
		alias
			"[
				((struct SDL_ControllerAxisEvent*)$an_item)->padding2
			]"
		end
	...
	set_c_padding2 (an_item: POINTER; a_value: CHARACTER) 
		...
		alias
			"[
				((struct SDL_ControllerAxisEvent*)$an_item)->padding2 =  (Uint8)$a_value
			]"
		ensure
	...
	c_padding3 (an_item: POINTER): CHARACTER
		...
		alias
			"[
				((struct SDL_ControllerAxisEvent*)$an_item)->padding3
			]"
		end
	...
	set_c_padding3 (an_item: POINTER; a_value: CHARACTER) 
		...
		alias
			"[
				((struct SDL_ControllerAxisEvent*)$an_item)->padding3 =  (Uint8)$a_value
			]"
		ensure
	...
	c_value (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct SDL_ControllerAxisEvent*)$an_item)->value
			]"
		end
	...
	set_c_value (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct SDL_ControllerAxisEvent*)$an_item)->value =  (Sint16)$a_value
			]"
		ensure
			value_set: a_value = c_value (an_item)
		end

	c_padding4 (an_item: POINTER): NATURAL
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
		alias
			"[
				((struct SDL_ControllerAxisEvent*)$an_item)->padding4
			]"
		end

	set_c_padding4 (an_item: POINTER; a_value: NATURAL) 
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
		alias
			"[
				((struct SDL_ControllerAxisEvent*)$an_item)->padding4 =  (Uint16)$a_value
			]"
		ensure
