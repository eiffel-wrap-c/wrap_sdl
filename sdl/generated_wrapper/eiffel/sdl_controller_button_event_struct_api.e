...
class SDL_CONTROLLER_BUTTON_EVENT_STRUCT_API
...
feature {NONE} -- Implementation wrapper for struct struct SDL_ControllerButtonEvent
	...
	c_type (an_item: POINTER): NATURAL
		...
		alias
			"[
				((struct SDL_ControllerButtonEvent*)$an_item)->type
			]"
		end
	...
	set_c_type (an_item: POINTER; a_value: NATURAL) 
		...
		alias
			"[
				((struct SDL_ControllerButtonEvent*)$an_item)->type =  (Uint32)$a_value
			]"
		ensure
	...
	c_timestamp (an_item: POINTER): NATURAL
		...
		alias
			"[
				((struct SDL_ControllerButtonEvent*)$an_item)->timestamp
			]"
		end
	...
	set_c_timestamp (an_item: POINTER; a_value: NATURAL) 
		...
		alias
			"[
				((struct SDL_ControllerButtonEvent*)$an_item)->timestamp =  (Uint32)$a_value
			]"
		ensure
	...
	c_which (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct SDL_ControllerButtonEvent*)$an_item)->which
			]"
		end
	...
	set_c_which (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct SDL_ControllerButtonEvent*)$an_item)->which =  (SDL_JoystickID)$a_value
			]"
		ensure
	...
	c_button (an_item: POINTER): CHARACTER
		...
		alias
			"[
				((struct SDL_ControllerButtonEvent*)$an_item)->button
			]"
		end
	...
	set_c_button (an_item: POINTER; a_value: CHARACTER) 
		...
		alias
			"[
				((struct SDL_ControllerButtonEvent*)$an_item)->button =  (Uint8)$a_value
			]"
		ensure
	...
	c_state (an_item: POINTER): CHARACTER
		...
		alias
			"[
				((struct SDL_ControllerButtonEvent*)$an_item)->state
			]"
		end
	...
	set_c_state (an_item: POINTER; a_value: CHARACTER) 
		...
		alias
			"[
				((struct SDL_ControllerButtonEvent*)$an_item)->state =  (Uint8)$a_value
			]"
		ensure
	...
	c_padding1 (an_item: POINTER): CHARACTER
		...
		alias
			"[
				((struct SDL_ControllerButtonEvent*)$an_item)->padding1
			]"
		end
	...
	set_c_padding1 (an_item: POINTER; a_value: CHARACTER) 
		...
		alias
			"[
				((struct SDL_ControllerButtonEvent*)$an_item)->padding1 =  (Uint8)$a_value
			]"
		ensure
	...
	c_padding2 (an_item: POINTER): CHARACTER
		...
		alias
			"[
				((struct SDL_ControllerButtonEvent*)$an_item)->padding2
			]"
		end
	...
	set_c_padding2 (an_item: POINTER; a_value: CHARACTER) 
		...
		alias
			"[
				((struct SDL_ControllerButtonEvent*)$an_item)->padding2 =  (Uint8)$a_value
			]"
		ensure
