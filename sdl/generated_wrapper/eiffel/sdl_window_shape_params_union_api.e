...
feature {ANY} -- Member Access
	...
	binarizationcutoff: CHARACTER 
		...
		do
			...
			result_correct: Result = c_binarizationcutoff (item)
		end

	set_binarizationcutoff (a_value: CHARACTER) 
...
feature {NONE} --C Implementation: SDL_WindowShapeParams
	...
	c_binarizationcutoff (an_item: POINTER): CHARACTER 
		require
	...
	set_c_binarizationcutoff (an_item: POINTER; a_value: CHARACTER) 
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
