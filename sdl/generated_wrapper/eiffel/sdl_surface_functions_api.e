...
feature -- Access
	...
	sdl_set_color_key (surface: SDL_SURFACE_STRUCT_API; flag: INTEGER; key: NATURAL): INTEGER 
		do
	...
	sdl_convert_surface (src: SDL_SURFACE_STRUCT_API; fmt: SDL_PIXEL_FORMAT_STRUCT_API; flags: NATURAL): detachable SDL_SURFACE_STRUCT_API 
		do
	...
	sdl_fill_rect (dst: SDL_SURFACE_STRUCT_API; rect: SDL_RECT_STRUCT_API; color: NATURAL): INTEGER 
		do
...
feature -- Externals
	...
	c_sdl_set_color_key (surface: POINTER; flag: INTEGER; key: NATURAL): INTEGER
		external
			"C inline use <SDL.h>"
		alias
			"[
	...
	c_sdl_convert_surface (src: POINTER; fmt: POINTER; flags: NATURAL): POINTER
		external
			"C inline use <SDL.h>"
		alias
			"[
	...
	c_sdl_fill_rect (dst: POINTER; rect: POINTER; color: NATURAL): INTEGER
		external
			"C inline use <SDL.h>"
		alias
			"[
