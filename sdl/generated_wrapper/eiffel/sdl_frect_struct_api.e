...
feature {NONE} -- Implementation wrapper for struct struct SDL_FRect

	sizeof_external: INTEGER 
		external
			"C inline use <SDL.h>"
		alias
			"sizeof(struct SDL_FRect)"
		end
	...
	set_c_x (an_item: POINTER; a_value: REAL) 
		...
		alias
			"[
				((struct SDL_FRect*)$an_item)->x =  (float)$a_value
			]"
		ensure
	...
	set_c_y (an_item: POINTER; a_value: REAL) 
		...
		alias
			"[
				((struct SDL_FRect*)$an_item)->y =  (float)$a_value
			]"
		ensure
			y_set: a_value = c_y (an_item)
		end

	c_w (an_item: POINTER): REAL
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
		alias
			"[
				((struct SDL_FRect*)$an_item)->w
			]"
		end

	set_c_w (an_item: POINTER; a_value: REAL) 
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
		alias
			"[
				((struct SDL_FRect*)$an_item)->w =  (float)$a_value
			]"
		ensure
			w_set: a_value = c_w (an_item)
		end

	c_h (an_item: POINTER): REAL
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
		alias
			"[
				((struct SDL_FRect*)$an_item)->h
			]"
		end

	set_c_h (an_item: POINTER; a_value: REAL) 
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
		alias
			"[
				((struct SDL_FRect*)$an_item)->h =  (float)$a_value
			]"
		ensure
