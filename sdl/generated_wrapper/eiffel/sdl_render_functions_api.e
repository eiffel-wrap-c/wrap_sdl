...
feature -- Access
	...
	sdl_create_renderer (window: SDL_WINDOW_STRUCT_API; index: INTEGER; flags: INTEGER): detachable SDL_RENDERER_STRUCT_API 
		do
	...
	sdl_render_get_logical_size (renderer: SDL_RENDERER_STRUCT_API; w: POINTER; h: POINTER) 
		do
	...
	sdl_render_get_scale (renderer: SDL_RENDERER_STRUCT_API; scalex: POINTER; scaley: POINTER) 
		do
	...
	sdl_set_render_draw_color (renderer: SDL_RENDERER_STRUCT_API; r: INTEGER; g: INTEGER; b: INTEGER; a: INTEGER): INTEGER 
		do
	...
	sdl_render_read_pixels (renderer: SDL_RENDERER_STRUCT_API; rect: SDL_RECT_STRUCT_API; format: INTEGER; pixels: POINTER; pitch: INTEGER): INTEGER 
		do
...
feature -- Externals
	...
	c_sdl_create_renderer (window: POINTER; index: INTEGER; flags: INTEGER): POINTER
		external
			"C inline use <SDL.h>"
		alias
			"[
	...
	c_sdl_render_get_logical_size (renderer: POINTER; w: POINTER; h: POINTER)
		external
			"C inline use <SDL.h>"
		alias
			"[
	...
	c_sdl_render_get_scale (renderer: POINTER; scalex: POINTER; scaley: POINTER)
		external
			"C inline use <SDL.h>"
		alias
			"[
	...
	c_sdl_set_render_draw_color (renderer: POINTER; r: INTEGER; g: INTEGER; b: INTEGER; a: INTEGER): INTEGER
		external
			"C inline use <SDL.h>"
		alias
			"[
	...
	c_sdl_render_read_pixels (renderer: POINTER; rect: POINTER; format: INTEGER; pixels: POINTER; pitch: INTEGER): INTEGER
		external
			"C inline use <SDL.h>"
		alias
			"[
