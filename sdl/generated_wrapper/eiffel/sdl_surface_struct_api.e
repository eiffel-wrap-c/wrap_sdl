...
feature {ANY} -- Member Access
	...
	list_blitmap: POINTER
			-- Access member `list_blitmap`
		require
			exists: exists
		do
			Result := c_list_blitmap (item)
		ensure
			result_correct: Result = c_list_blitmap (item)
		end

	set_list_blitmap (a_value: POINTER) 
			-- Change the value of member `list_blitmap` to `a_value`.
		require
			exists: exists
		do
			set_c_list_blitmap (item, a_value)
		ensure
			list_blitmap_set: a_value = list_blitmap
		end
...
feature {NONE} -- Implementation wrapper for struct struct SDL_Surface
	...
	c_pitch (an_item: POINTER): INTEGER
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
	...
	set_c_pitch (an_item: POINTER; a_value: INTEGER) 
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
	...
	c_locked (an_item: POINTER): INTEGER
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
	...
	set_c_locked (an_item: POINTER; a_value: INTEGER) 
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
	...
	c_list_blitmap (an_item: POINTER): POINTER
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
		alias
			"[
				((struct SDL_Surface*)$an_item)->list_blitmap
			]"
		end

	set_c_list_blitmap (an_item: POINTER; a_value: POINTER) 
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
		alias
			"[
				((struct SDL_Surface*)$an_item)->list_blitmap =  (void*)$a_value
			]"
		ensure
			list_blitmap_set: a_value = c_list_blitmap (an_item)
		end
