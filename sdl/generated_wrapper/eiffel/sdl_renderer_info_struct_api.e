...
class SDL_RENDERER_INFO_STRUCT_API
...
feature {ANY} -- Member Access
	...
	set_num_texture_formats (a_value: NATURAL) 
	...
	set_max_texture_width (a_value: INTEGER) 
	...
	set_max_texture_height (a_value: INTEGER) 
...
feature {NONE} -- Implementation wrapper for struct struct SDL_RendererInfo
	...
	c_num_texture_formats (an_item: POINTER): NATURAL
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
	...
	set_c_num_texture_formats (an_item: POINTER; a_value: NATURAL) 
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
	...
	c_max_texture_width (an_item: POINTER): INTEGER
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
	...
	set_c_max_texture_width (an_item: POINTER; a_value: INTEGER) 
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
	...
	c_max_texture_height (an_item: POINTER): INTEGER
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
	...
	set_c_max_texture_height (an_item: POINTER; a_value: INTEGER) 
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <SDL.h>"
