...
feature {NONE} -- Implementation wrapper for struct struct SDL_Point

	sizeof_external: INTEGER 
		external
			"C inline use <SDL.h>"
		alias
			"sizeof(struct SDL_Point)"
		end
	...
	set_c_x (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct SDL_Point*)$an_item)->x =  (int)$a_value
			]"
		ensure
	...
	set_c_y (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct SDL_Point*)$an_item)->y =  (int)$a_value
			]"
		ensure
